...
<br>
<br>
<span class="openingParagraph">As blockchains have gained popularity, government use and oversight of blockchains have been a topic of interest for administrators on the local, state, and federal level. Many jurisdictions are taking a proactive approach to studying the impact of blockchain technology.</span>
...
<span style="font-weight: 400;">As discussed in Blockchain 101, Proof-of-Work mining consumes a lot of energy and has caught the eye of some regulators. Mining regulations vary from the national to the municipal level, depending on the unique energy situation dictated by the price and availability of energy. </span>
...
<span style="font-weight: 400;">In the United States, securities are defined by the Howey test. Formed in 1934 under the Security Exchange Act, the Howey test consists of four parts:</span>
<ul>
...
<span style="font-weight: 400;">This was illustrated when ICOs, a popular way to initially distribute coins, took the cryptocurrency scene by storm. As previously mentioned, this method of fundraising has brought in billions, garnering the attention of governments worldwide. The United States Securities and Exchange Commission has been monitoring ICOs, making sure basic compliance is being met. There has also been a battle over how these tokens should be classified, which will have great implications concerning taxation.</span>
